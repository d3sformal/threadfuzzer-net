...
{
    [BenchmarkInfo(DegreeOfConcurrency = 2, Notes = "fields -> properties; much higher timeout")]
    public class BluetoothDriverBadTweaked : IBenchmark
    {
        private readonly SemaphoreSlim DataLock = new SemaphoreSlim(1,1);

        private int PendingIo = 1;
        private bool StoppingFlag { get; set; }
        private bool StoppingEvent { get; set; }
