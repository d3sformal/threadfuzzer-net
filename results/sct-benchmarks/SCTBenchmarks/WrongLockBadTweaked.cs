...
{
    [BenchmarkInfo(DegreeOfConcurrency = 1 + 7 + 1, Notes = "fields -> properties")]
    public class WrongLockBadTweaked : WrongLockBadTweakedBase, IBenchmark
    {
        public void RunTest()
        {
            RunTest(1, 7);
    ...
    public class WrongLockBadTweakedBase
    {
